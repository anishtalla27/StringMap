...
page('index.html','Guitar notation and practice','<h1>StringMap</h1><p>Guitar notation, tablature, and practice for iPhone and iPad.</p><p>Practice with 18 original single-note guitar exercises, synchronized notation, playback, and fretboard positions. Music works offline.</p><p>Read the privacy policy, get support, or review the bundled licenses using the links above.</p>')
