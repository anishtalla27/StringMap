...
# Keep foundation resources unchanged; append the original continuation.
import runpy
runpy.run_path("scripts/extend-tutorial-course.py")

with (root/'PROVENANCE.md').open('a') as f:
 f.write("\nLessons 13–24 are original material authored in scripts/extend-tutorial-course.py. Teaching background only: https://www.thisisclassicalguitar.com/lesson-shifts-string-squeak-guitar/ ; https://www.justinguitar.com/guitar-lessons/triad-chord-grips-im-151 ; https://www.thisisclassicalguitar.com/lesson-slurs-for-classical-guitar/ . No source arrangements, recordings, or scripts are copied.\n")
